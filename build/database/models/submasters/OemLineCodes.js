...
exports.OemLineCodes = void 0;
const sequelize_1 = __importStar(require("sequelize"));
const database_1 = require("../../database");
const process_1 = require("process");
const Company_1 = __importDefault(require("../masters/Company"));
exports.OemLineCodes = database_1.sequelize.define("oem_line_codes", {
    id: {
...
exports.OemLineCodes.belongsTo(Company_1.default, { constraints: true, foreignKey: "company_id" });
exports.OemLineCodes.addHook("beforeCreate", (oemLineCode) => __awaiter(void 0, void 0, void 0, function* () {
    // Find the current prefix code from the PrefixCodes table
    const prefixCodeRow = process_1.env.OEM_CODE;
    if (!prefixCodeRow) {
    ...
    const existingCodes = yield exports.OemLineCodes.findAll({
        where: {
            sequence_number: {
...
exports.default = exports.OemLineCodes;
