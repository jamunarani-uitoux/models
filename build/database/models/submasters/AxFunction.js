...
exports.AxFunction = void 0;
const sequelize_1 = __importStar(require("sequelize"));
const database_1 = require("../../database");
const process_1 = require("process");
const Company_1 = __importDefault(require("../masters/Company"));
const BusinessUnit_1 = __importDefault(require("./BusinessUnit"));
const CustomerLoB_1 = __importDefault(require("./CustomerLoB"));
exports.AxFunction = database_1.sequelize.define("ax_functions", {
    id: {
...
exports.AxFunction.belongsTo(BusinessUnit_1.default, { constraints: true, foreignKey: "business_unit_id" });
exports.AxFunction.belongsTo(CustomerLoB_1.default, { constraints: true, foreignKey: "lob_id" });
exports.AxFunction.belongsTo(Company_1.default, { constraints: true, foreignKey: "company_id" });
exports.AxFunction.addHook("beforeCreate", (axFunction) => __awaiter(void 0, void 0, void 0, function* () {
    // Find the current prefix code from the PrefixCodes table
    const prefixCodeRow = process_1.env.AX_FUNCTION_CODE;
    if (!prefixCodeRow) {
    ...
    const existingCodes = yield exports.AxFunction.findAll({
        where: {
            sequence_number: {
...
exports.default = exports.AxFunction;
